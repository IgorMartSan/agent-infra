...
class RabbitMQProducer:
    ...
    def publish(
        ...
        try:
            self._publish_once(exchange, routing_key, message)
        except (
            ...
            # O broker pode encerrar conexões ociosas entre duas requisições.
            # Descarta o cliente antigo e repete a publicação uma única vez.
